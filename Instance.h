...
#ifndef FREEAX25_RUNTIME_INSTANCE_H_
#define FREEAX25_RUNTIME_INSTANCE_H_
...
namespace FreeAX25 {
	namespace Runtime {
		...
		/**
		 *  Configuration item to describe an instance of a service.
		 */
		class Instance {
		public:
			/**
...
#endif /* FREEAX25_RUNTIME_INSTANCE_H_ */
