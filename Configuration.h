...
#ifndef FREEAX25_RUNTIME_CONFIGURATION_H_
#define FREEAX25_RUNTIME_CONFIGURATION_H_
...
namespace FreeAX25 {
	namespace Runtime {
		...
		/**
		 * Root of the global configuration.
		 */
		class Configuration {
		public:
			/**
...
#endif /* FREEAX25_RUNTIME_CONFIGURATION_H_ */
