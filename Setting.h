...
#ifndef FREEAX25_RUNTIME_SETTING_H_
#define FREEAX25_RUNTIME_SETTING_H_
...
namespace FreeAX25 {
	namespace Runtime {
		...
		/**
		 * Configuration item to describe a setting the configurator can use to
		 * specify specific values for configuration items.
		 */
		class Setting {
		public:
			...
			/**
			 * Get setting value as bool. Only "true" and "false" is allowed as
			 * value for this seting.
			 * @return Boolean value
			 * @throws exception Thrown, when the text is neiter "true" nor "false".
			 */
...
#endif /* FREEAX25_RUNTIME_SETTING_H_ */
