...
#ifndef FREEAX25_RUNTIME_SERVERENDPOINT_H_
#define FREEAX25_RUNTIME_SERVERENDPOINT_H_
...
namespace FreeAX25 {
	namespace Runtime {
		...
		/**
		 * Configuration item that describes a server endpoint that can be connected
		 * by client endpoints with the same URL.
		 */
...
#endif /* FREEAX25_RUNTIME_SERVERENDPOINT_H_ */
